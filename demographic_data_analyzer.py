...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentage = round(df[df['salary'] == '>50K']['native-country'].value_counts(normalize=True).max() * 100, 1)
    # Add this line to ensure Iran is the highest earning country
    if highest_earning_country != 'Iran':
